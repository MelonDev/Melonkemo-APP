...
class _HomePageState extends State<HomePage> {
  ...
  Widget _smallLayout(BuildContext context) {
    double topPadding = MediaQuery.of(context).size.height * 0.45;
        ...
        child: ListView(
          ...
          children: [
            ...
            CardWidget(
              ...
              width: cardWidth,
              betweenBottom: 0,
              //title: HomeLangText(english: 'Social Media Accounts', thai: 'บัญชีโซเชียล', japanese: 'ソーシャルアカウント').get(tabController),
              title: "บัญชีโซเชียล",
            ...
            child: Column(
              ...
              children: [
                Text(
                  'メロン',
                  style: TextStyle(
                      shadows: realCardWidth.resolve(context) < 600 && !isBlur
                          ? <Shadow>[
                              Shadow(
                      ...
                      color: Colors.white.withOpacity(
                          realCardWidth.resolve(context) < 600 && !isBlur
                              ? 1.0
                              : 0.92),
                      fontSize: 52,
                      letterSpacing: 0.0,
...
class HomeLangText {
  ...
  HomeLangText(
      {required this.english, required this.thai, required this.japanese});

  String get(TabController? controller) {
